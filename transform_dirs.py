...
output: The pattern for the new file or directory paths. Use '#n' to represent the part of the path that will be replaced by '#n' in p1.
'n' can be any singe digit integer
output can include formatting strings for integers (e.g. '%03d') which will be replaced by the index of the file or directory in the list of matches.


Optional arguments:
--move: If this argument is provided, the files or directories matching p1 will be moved to the new paths specified by output. If this argument is not provided, the script will try to copy the files instead.

--delete: Ift this argument is provided, files matching p1 will be deleted. output is not required in this case.
...
if args.output is None and not args.delete:
    raise ValueError("You must provide a second argument (output) unless you are deleting files.")
...
# output = '/data01/mc48/latent-diffusion/datasets/claw_data/full_frames/for_scale_2_frames_full/GH010058/raw'
# p1 = "/Users/mc48/Desktop/20bn-something-something-v2-#1.zip"
# output = "~/Desktop/copy/#1/fil.zip"

# p1 = "/Users/mc48/Desktop/20bn-something-something-v2-#1.zip"
# output = "/Users/Desktop/something/20bn-something-something-v2-#1.zip"
def to_glob(pat):
